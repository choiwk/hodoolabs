  ...
  return (
    <div className={styles.liveContainer}>
      <div className={styles.textContainer}>
        <div   className={classNames({[styles.title]:true, [scrollPosition > 2000 ? styles.titleAnimation : styles.title]: true })} >실시간 방송 형태로 제공되는 <br/> 신개념 책 읽기 </div>
        <div  className={classNames({[styles.text]:true, [scrollPosition > 2000 ? styles.textAnimation : styles.text]: true })}>방송 중이라면 언제든 접속하세요. <br/> 수강신청, 수업예약 없이 편하게 수업참여가 가능해요.</div>
      </div>
