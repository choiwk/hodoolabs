  ...
  return (
    <div className={styles.diaryContainer}>
      <div className={styles.textContainer}>
        <div className={classNames({ [styles.title]: true, [scrollPosition > 3200 ? styles.titleAnimation : styles.title]: true })}>
          매일매일
          <br /> 알아서 기록하는 독서 일기
        </div>
        <div className={classNames({ [styles.text]: true, [scrollPosition > 3200 ? styles.textAnimation : styles.text]: true })}>
